...
urlpatterns = [
    ...
    path('project/use/<int:pk>', views.project_use, name='project_use'),
    path('project/use', views.project_use, name='project_use'),
    #region Measurement
    ...
    #region SensorNode
    path('project/<int:project_pk>/sensor_node_list', views.sensor_node_list, name='sensor_node_list'),
    ...
    path('sensor_node/edit/<int:pk>', views.sensor_node_edit, name='sensor_node_edit'),
