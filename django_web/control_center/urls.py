...
urlpatterns = [
    ...
    path('project/<int:project_pk>/sensor_node_list', views.project_sensor_node_list, name='sensor_node_list'),
    ...
    #region SensorNode
    path('sensor_node/<int:pk>/edit', views.sensor_node_edit, name='sensor_node_edit'),
