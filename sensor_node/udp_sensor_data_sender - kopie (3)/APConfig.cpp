...
APConfig::APConfig(const char* apSSID, const char* apPassword, int resetPin, int statusLED)
  : apSSID(apSSID), apPassword(apPassword), resetPin(resetPin), statusLED(statusLED), server(80) {
}
